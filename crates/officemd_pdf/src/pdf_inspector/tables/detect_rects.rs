...
mod tests {
    ...
    fn hint_from_failed_large_clusters() {
        ...
        let items: Vec<TextItem> = vec![];
        let rects: Vec<crate::pdf_inspector::types::PdfRect> = page_rects
            .iter()
            .map(|&(x, y, w, h)| crate::pdf_inspector::types::PdfRect {
                x,
                y,
                width: w,
                height: h,
    ...
    fn no_hint_too_few_rects() {
        ...
        let rects: Vec<crate::pdf_inspector::types::PdfRect> = (0..5)
            .map(|i| crate::pdf_inspector::types::PdfRect {
    ...
    fn no_hint_page_spanning_width() {
        ...
        for i in 0..12 {
            page_rects.push(crate::pdf_inspector::types::PdfRect {
                x: i as f32 * 40.0,
                y: 100.0,
                width: 38.0,
                height: 10.0,
